...
class Hello
{
    ...
    public void parseSomeJSON() throws Exception {
        String path = "/Users/wfolkes/dev/learning-java/src/main/java/test.json";
        JSONObject testObject = (JSONObject) readJsonFile(path);
        System.out.println(testObject);
    }

    public Object readJsonFile(String file) throws Exception {
